...
// Preload the laparoscopic trocar model for performance
useGLTF.preload('/laparoscopic_trocar.glb');
...
const LaparoscopicTrocarMini = forwardRef<Group, LaparoscopicTrocarMiniProps>(({ mode, initialParams, onUpdate }, ref) => {
  ...
  return (
    <>
      <group
        ref={groupRef}
        name="LaparoscopicTrocar_Miniature"
...
export default LaparoscopicTrocarMini;
