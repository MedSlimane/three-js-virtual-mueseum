...
const FramedArt_Zahrawi1: React.FC<FramedArtProps> = ({ position = [0, 0, 0], scale = [1, 1, 1], rotation = [0, 0, 0] }) => {
  ...
  const texture = useLoader(TextureLoader, '/pictures/Zahrawi1.png');
