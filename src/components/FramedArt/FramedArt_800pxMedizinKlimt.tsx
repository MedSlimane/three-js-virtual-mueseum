...
const FramedArt_800pxMedizinKlimt: React.FC<FramedArtProps> = ({ position = [0, 0, 0], scale = [1, 1, 1], rotation = [0, 0, 0] }) => {
  ...
  const texture = useLoader(TextureLoader, '/pictures/800px-Medizin_Klimt.jpg');
...
export { FramedArt_800pxMedizinKlimt };
